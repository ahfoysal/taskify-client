...
const Explore: React.FC = () => {
  ...
  return (
    ...
    <p className="text-xl font-medium">Why You&apos;ll Use Our App</p>
        <h1 className="text-3xl font-bold mt-6">Explore all Taskify has to offer
</h1>
    </div>
            ...
            <Col key={index} span={6}>
              ...
              <Card
                ...
                cover={<div className='p-2'>
                  <Image src={item.src} className='h-[127px] w-full flex justify-center items-center' height={80} width={40} alt='card' />
                </div>}
                headStyle={{
                  fontSize: "14px",
                  whiteSpace: "pre-wrap",
